...
| `EMBED_PROVIDER` | `ollama` | 嵌入提供者：`ollama`、`openai`、`google`、`cloudflare` |
| `EMBED_MODEL` | 按提供者默认 | 嵌入模型。默认：`bge-m3`、`text-embedding-3-small`、`gemini-embedding-2`、`@cf/baai/bge-large-en-v1.5` |
